...
export default function Login() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const { data } = await api.post('/api/auth/login', { ...form, role: 'delivery_partner' })
        ...
        <div className="min-h-screen flex items-center justify-center p-4">
            <div className="w-full max-w-md">
                <div className="text-center mb-10">
                    ...
                    <p className="text-gray-400">Delivery Partner Portal</p>
                </div>
                <div className="card space-y-5">
                    ...
                    <p className="text-center text-sm text-gray-400">
                        New partner?{' '}
                        <Link to="/register" className="text-brand-500 hover:underline font-medium">Create account</Link>
                    </p>
                </div>
            </div>
        </div>
